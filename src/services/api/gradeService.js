...
const gradeService = {
  ...
  async create(gradeData) {
    try {
      ...
      const formattedData = {
        Name: gradeData.Name || `Grade for Assignment ${gradeData.assignmentId}`,
        Tags: gradeData.Tags || "",
        ...
        studentId: gradeData.studentId ? parseInt(gradeData.studentId) : null,
        assignmentId: gradeData.assignmentId ? parseInt(gradeData.assignmentId) : null
      };
